...
app.UseCors(builder => builder.WithOrigins("http://contas.gamidas.dev.br", "http://bills-calculate-percentage.gamidas.dev.br", "http://bills.gamidas.dev.br").AllowAnyHeader().AllowAnyMethod());
app.UseSwagger();
app.UseSwaggerUI();
